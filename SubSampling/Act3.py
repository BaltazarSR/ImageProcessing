...
img_gaussian = cv2.filter2D(img, ddepth=-1, kernel=gaussian_filter)
...
subsampled2_gaussian = cv2.filter2D(subsampled2_after, ddepth=-1, kernel=gaussian_filter)
subsampled4_gaussian = cv2.filter2D(subsampled4_after, ddepth=-1, kernel=gaussian_filter)
subsampled8_gaussian = cv2.filter2D(subsampled8_after, ddepth=-1, kernel=gaussian_filter)
